...
Особенностью библиотеки является использование [Pydantic](https://docs.pydantic.dev/) для валидации и сериализации данных.
...
## [Примеры использования](https://github.com/KatantDev/YMdantic/tree/main/examples)
